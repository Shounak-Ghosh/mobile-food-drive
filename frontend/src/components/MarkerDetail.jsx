  ...
  return (
    <div className="bg-white rounded-lg p-4 shadow-lg max-w-md w-full">
      <div className="flex justify-between items-start mb-3">
        <h2 className="text-xl font-bold">{marker.food_display_info.food_type}</h2>
      ...
      <div className="mb-3">
        <p className="text-gray-700">{marker.food_display_info.description}</p>
        <p className="text-sm text-gray-600 mt-1">
          Quantity: {marker.food_display_info.quantity}
        </p>
      </div>
      ...
      {/* Display dietary tags if they exist in food_display_info */}
      {marker.food_display_info.dietary_tags && marker.food_display_info.dietary_tags.length > 0 && (
        <div className="flex flex-wrap gap-1 mb-3">
          {marker.food_display_info.dietary_tags.map(tag => (
